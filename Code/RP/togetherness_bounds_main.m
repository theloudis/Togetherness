function [pass,fvalue,xselect] = togetherness_bounds_main(l,Cp,T,Ck,deltam,deltaK,gamma,spec)
...
%% PART V : Impose that final variable (nrvars) is average proportion of joint childcare
counts=0;
for s=1:V
...
%% PART VI : Objective function: Minimize or maximize average proportion of joint childcare
f = zeros(nrvars,1);
if strcmp(spec,'lb')==1
   f(nrvars,1) = 1;
